...
function buildCategories() {
  const cats = [
    { name: "30.1 Premium", img: "public/imagem/colecao/30.1.png", coll: "colecao-30-1" },
    { name: "Oversized", img: "public/imagem/colecao/oversized.png", coll: "oversized" },
    { name: "Shorts", img: "public/imagem/colecao/2.jpg", coll: "shorts-calcas" }
  ];
